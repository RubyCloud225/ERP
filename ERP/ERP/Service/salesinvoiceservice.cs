...
namespace ERP.Service
{
    public class SalesInvoiceService : ISalesInvoiceService
    {
        ...
        {
            // use LLM to create a sales invoice
            string prompt = await _documentProcessor.GeneratePromptFromSalesInvoiceAsync(blobName, invoiceDate, invoiceNumber, customerName, customerAddress, totalAmount, salesTax, netAmount);
